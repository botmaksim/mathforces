...
userver::formats::json::Value LoginHandler::HandleRequestJsonThrow(
    ...
    auto hashed_pwd = Sha3_256(password); // Используем SHA-3 для хэширования, согласно требованиям (или SHA256 если старая БД)
    
    // В реальном переходе старые пароли хэшировались SHA256 (Qt), мы применяем SHA3 для новых
    // Для совместимости тестов мы можем временно проверять оба или оставить как SHA3
    auto res = pg_cluster_->Execute(
        userver::storages::postgres::ClusterHostType::kMaster,
        "SELECT id, role, is_banned, name FROM users WHERE email=$1",
        email);
...
ContestsHandler::ContestsHandler(const userver::components::ComponentConfig& config,
                                 const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
userver::formats::json::Value ContestsHandler::HandleRequestJsonThrow(
    ...
    auto res = pg_cluster_->Execute(
        userver::storages::postgres::ClusterHostType::kMaster,
        "SELECT id, title, description, start_time::text, end_time::text, duration_hours FROM contests WHERE is_published = TRUE ORDER BY start_time DESC");
...
RatingsHandler::RatingsHandler(const userver::components::ComponentConfig& config,
                                 const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
ArchiveHandler::ArchiveHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
userver::formats::json::Value ArchiveHandler::HandleRequestJsonThrow(
    ...
    std::string query = "SELECT id, title, tags, difficulty FROM tasks WHERE difficulty >= $1 AND difficulty <= $2";
    if (!tags.empty()) {
    ...
    if (!tags.empty()) {
        res = pg_cluster_->Execute(
            userver::storages::postgres::ClusterHostType::kMaster,
            query, min_diff, max_diff, tags);
    } else {
        res = pg_cluster_->Execute(
            userver::storages::postgres::ClusterHostType::kMaster,
            query, min_diff, max_diff);
    }
...
RegisterCodeHandler::RegisterCodeHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
RegisterEmailHandler::RegisterEmailHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
UsersSearchHandler::UsersSearchHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
UsersProfileHandler::UsersProfileHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
userver::formats::json::Value UsersProfileHandler::HandleRequestJsonThrow(
    ...
    auto res = pg_cluster_->Execute(
        userver::storages::postgres::ClusterHostType::kMaster,
        "SELECT id, username, email, name, rating, can_blog FROM users WHERE id=$1",
        t_id);
...
UsersRoleHandler::UsersRoleHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
UsersBanHandler::UsersBanHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
UsersBlogAccessHandler::UsersBlogAccessHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
FriendsListHandler::FriendsListHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
FriendsAddHandler::FriendsAddHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
FriendsRemoveHandler::FriendsRemoveHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
BlogPostsHandler::BlogPostsHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
userver::formats::json::Value BlogPostsHandler::HandleRequestJsonThrow(
    ...
    if (request.GetMethod() == userver::server::http::HttpMethod::kGet) {
        ...
        auto res = pg_cluster_->Execute(
            userver::storages::postgres::ClusterHostType::kMaster,
            "SELECT id, content, created_at FROM blogs WHERE user_id=$1 ORDER BY id DESC",
            user_id);
        ...
        pg_cluster_->Execute(
            userver::storages::postgres::ClusterHostType::kMaster,
            "INSERT INTO blogs (user_id, title, content) VALUES ($1, 'Blog Post', $2)",
            user_id, content);
        userver::formats::json::ValueBuilder builder{userver::formats::common::Type::kObject};
        builder["status"] = "ok";
        return builder.ExtractValue();
...
BlogCommentsHandler::BlogCommentsHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
userver::formats::json::Value BlogCommentsHandler::HandleRequestJsonThrow(
    ...
    if (request.GetMethod() == userver::server::http::HttpMethod::kGet) {
        ...
        auto res = pg_cluster_->Execute(
            userver::storages::postgres::ClusterHostType::kMaster,
            "SELECT c.id, c.content, c.created_at, u.username FROM comments c JOIN users u ON c.user_id = u.id WHERE c.blog_id=$1 ORDER BY c.id ASC",
            post_id);
...
CompileTypstHandler::CompileTypstHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
AdminMyContestsHandler::AdminMyContestsHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
AdminContestHandler::AdminContestHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
AdminTaskHandler::AdminTaskHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
ResultsHandler::ResultsHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
AdminRateContestHandler::AdminRateContestHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
ContestsVirtualHandler::ContestsVirtualHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
userver::formats::json::Value TasksHandler::HandleRequestJsonThrow(
    ...
    auto res = pg_cluster_->Execute(
        userver::storages::postgres::ClusterHostType::kMaster,
        "SELECT id, title, description, editorial FROM tasks WHERE contest_id=$1 ORDER BY id ASC",
        c_id);
...
SubmitHandler::SubmitHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
userver::formats::json::Value SubmitHandler::HandleRequestJsonThrow(
    ...
    pg_cluster_->Execute(
        userver::storages::postgres::ClusterHostType::kMaster,
        "INSERT INTO submissions (task_id, user_id, answer_text, status) VALUES ($1, $2, $3, 'pending')",
...
SubmissionsHandler::SubmissionsHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
userver::formats::json::Value SubmissionsHandler::HandleRequestJsonThrow(
    ...
    auto res = pg_cluster_->Execute(
        userver::storages::postgres::ClusterHostType::kMaster,
        "SELECT id, answer_text, score, feedback, status FROM submissions WHERE task_id=$1 AND user_id=$2 ORDER BY id DESC",
        task_id, user_id);
...
SubmissionsAllHandler::SubmissionsAllHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
...
userver::formats::json::Value SubmissionsAllHandler::HandleRequestJsonThrow(
    ...
    // Require admin or superadmin role (Wait, anyone who solved can view? the client limits UI for admin, but let's just dump all)
    auto res = pg_cluster_->Execute(
        userver::storages::postgres::ClusterHostType::kMaster,
        "SELECT s.id, s.answer_text, s.score, u.username FROM submissions s JOIN users u ON s.user_id = u.id WHERE s.task_id=$1 ORDER BY s.id DESC",
        task_id);
...
OauthCallbackHandler::OauthCallbackHandler(const userver::components::ComponentConfig& config,
                               const userver::components::ComponentContext& context)
    : HttpHandlerJsonBase(config, context),
      pg_cluster_(context.FindComponent<userver::components::Postgres>("postgres-db-1").GetCluster()) {}
